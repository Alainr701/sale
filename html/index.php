            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="#" class="app-brand-link gap-2">
                  <img src="../assets/logo.png" alt="logo" class="app-brand-logo demo" />
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Bienvenidos al Sistema 👋</h4>
              <p class="mb-4">Prestamos de Equipos y Ambientes</p>

              <form id="formAuthentication" class="mb-3" action="controllers/login_controller.php" method="POST">
                <div class="mb-3">

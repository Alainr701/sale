...
if ($resultado->num_rows > 0) {
    ...
    // dato_docente, asignatura, entregado_por, fecha_hora, equipo, ambiente, carrera
    $materia = $fila['asignatura'];
    $docente  = $fila['dato_docente'];
...
$id_equipo =  $equipo;
$equipo =   $result_equipo->fetch_assoc()['nombre_equipo'];
...
$ambiente = $result_ambiente->fetch_assoc()['nombre_ambiente'];
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
              <div class="card p-4">
                  <h5 class="card-header">Editar Prestamos</h5>


<form id="newForm" method="post" action="controllers/guardar_controller.php">
    <input type="hidden" name="id" value="<?php echo $id; ?>">
    <div class="form-group">
        <label for="materia">Materia</label>
        <input type="text" class="form-control" id="materia" name="materia" value="<?php echo $materia; ?>" required>
    </div>
    <!-- Add Bootstrap classes to the form-group divs -->
    <div class="form-group">
        <label for="docente">Docente</label>
        <input type="text" class="form-control" id="docente" name="docente" value="<?php echo $docente; ?>" required>
    </div>
    <div class="form-group">
        <label for="entregadoPor">Entregado Por</label>
        <input type="text" class="form-control" id="entregadoPor" name="entregadoPor" value="<?php echo $entregadoPor; ?>" required>
    </div>
    <div class="form-group">
        <label for="fechaHora">Fecha y Hora</label>
        <input type="datetime-local" class="form-control" id="fechaHora" name="fechaHora" value="<?php echo $fechaHora; ?>" required>
    </div>
    <div class="form-group">
        ...
        <select class="form-control" id="equipo" name="equipo" required>
            ...
            $result_equipo = $conn->query($sql_equipo);
            echo "<option value='" . $id_equipo . "'>" . $equipo . "</option>";
    ...
    <div class="form-group">
        ...
        <select class="form-control" id="ambiente" name="ambiente" required>
            ...
            $result_ambiente = $conn->query($sql_ambiente);
            echo "<option value='" . $id_ambiente . "'>" . $ambiente . "</option>";
